  ...
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-2">Aggregate trends across 14 practice sessions.</p>
      </div>

      <div className="grid grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded shadow border">
          <h3 className="text-gray-500 font-semibold mb-2">Average Pace</h3>
        ...
        <div className="bg-white p-6 rounded shadow border">
          <h3 className="text-gray-500 font-semibold mb-2">Filler Word Density</h3>
          <div className="text-4xl font-mono">3.2%</div>
          <div className="text-red-500 text-sm mt-2 font-bold">↑ 1.2% in System Design</div>
        </div>

        <div className="bg-white p-6 rounded shadow border">
          <h3 className="text-gray-500 font-semibold mb-2">STAR Consistency</h3>
          <div className="text-4xl font-mono">68%</div>
          <div className="text-gray-500 text-sm mt-2 font-semibold">Missing 'Action' most frequently</div>
        </div>
      </div>

      <div className="bg-white p-8 rounded shadow border h-64 flex items-center justify-center">
